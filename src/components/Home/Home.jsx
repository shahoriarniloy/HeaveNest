...
<p className='text-gray-600 text-center '>Explore By Your Preference!</p>
           <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 mt-12' data-aos="flip-left"
     ...
     data-aos-duration="2000">
           <div className="card w-full  col-span-2 h-64 bg-base-100 shadow-xl image-full">
            ...
            <div className="card-body">
                ...
                <Link to="/rent"><button className="btn bg-white text-black w-60 ">View Rents</button></Link>
                </div>
            </div>
            </div>

            <div className="card  w-full col-span-2  h-64 bg-base-100 shadow-xl image-full" data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                <Link to="/sale"><button className="btn bg-white text-black w-60 ">View Sales</button></Link>
                </div>
            </div>
            </div>
